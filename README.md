...
*   **Step 2: 리스크 추론 엔진 (Inference Engine)**
    *   LightGBM 기반의 최적화된 모델을 서빙하여 실시간 데이터에 대한 **상장폐지 위험도 점수(Risk Score)**를 산출합니다.
*   **Step 3: 인터랙티브 리포트 (Interactive Reporting)**
    *   '정상/주의/위험' 3단계 경보 시스템과 함께 위험 기여도가 높은 주요 지표를 그래프로 시각화하여 직관적인 투자 판단을 지원합니다.
